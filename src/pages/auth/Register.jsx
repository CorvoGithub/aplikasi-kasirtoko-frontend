...
import { 
  ...
  TrendingUp, Package, Wallet, History // Changed BarChart3 to History
} from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.password !== formData.password_confirmation) {
        return triggerToast("Password tidak cocok", 'error');
    }
    setLoading(true);
    try {
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-[#307fe2] relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="p-2 bg-white/10 rounded-lg backdrop-blur-sm">
            <img src="/images/m_white.png" alt="Mantra POS" className="w-6 h-6 object-contain" />
          </div>
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center">
            ...
            <div className="relative w-full max-w-sm animate-[float_6s_ease-in-out_infinite]">
                ...
                <div className="relative z-30 bg-white p-4 rounded-2xl shadow-xl shadow-blue-900/20 mb-4 transform opacity-0 animate-[entryUp_0.6s_ease-out_forwards]">
                    <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider">Pendapatan</span>
                        </div>
                        <span className="text-emerald-500 text-xs font-bold flex items-center">+24% <TrendingUp size={12} className="ml-1"/></span>
                    </div>
                    <h3 className="text-2xl font-bold text-slate-800">Rp 12.500.000</h3>
                </div>

                {/* Card 2: Sales History (Middle) - UPDATED VISUALS */}
                <div className="relative z-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-lg mb-4 transform opacity-0 animate-[entryUp_0.6s_ease-out_0.15s_forwards]">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-[#ffad00] rounded-lg text-white">
                            <History size={20} />
                        </div>
                        <div>
                            <p className="text-sm font-bold text-white">Riwayat Penjualan</p>
                            <p className="text-xs text-blue-100">Jejak transaksi lengkap</p>
                        </div>
                    </div>
                    
                    {/* Fake Transaction List Visuals */}
                ...
                {/* Card 3: New Product (Bottom) */}
                <div className="relative z-10 bg-slate-900 p-4 rounded-2xl shadow-xl transform opacity-0 animate-[entryUp_0.6s_ease-out_0.3s_forwards] ml-8">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-emerald-500/20 text-emerald-400 rounded-lg">
                            <Package size={20} />
                        </div>
                        <div>
                            <p className="text-xs text-slate-400">Stok Barang</p>
                            <p className="text-sm font-bold text-white">Produk Berhasil Ditambahkan</p>
                        </div>
        ...
        <div className="relative z-10">
            ...
            <p className="text-blue-100 text-sm opacity-80">Integrasikan berbagai aspek pengelolaan toko dalam satu tempat.</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-8">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input name="name" type="text" required className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-[#307fe2] focus:ring-1 focus:ring-[#307fe2] transition-all" placeholder="Nama Pemilik Toko" onChange={handleChange} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input name="store_name" type="text" required className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-[#307fe2] focus:ring-1 focus:ring-[#307fe2] transition-all" placeholder="Contoh: Toko Berkah" onChange={handleChange} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input name="email" type="email" required className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-[#307fe2] focus:ring-1 focus:ring-[#307fe2] transition-all" placeholder="nama@email.com" onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><Lock className="h-5 w-5 text-slate-400 group-focus-within:text-[#307fe2] transition-colors" /></div>
                    <input name="password" type="password" required className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-[#307fe2] focus:ring-1 focus:ring-[#307fe2] transition-all" placeholder="••••••••" onChange={handleChange} />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><Lock className="h-5 w-5 text-slate-400 group-focus-within:text-[#307fe2] transition-colors" /></div>
                    <input name="password_confirmation" type="password" required className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-lg focus:outline-none focus:border-[#307fe2] focus:ring-1 focus:ring-[#307fe2] transition-all" placeholder="••••••••" onChange={handleChange} />
                  </div>
                </div>
            </div>
