      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Ringkasan performa toko Mantra Anda hari ini.
          </p>
        </div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <h3
                className="text-2xl font-bold text-slate-900 mt-1 mb-1 truncate"
                title={stat.value}
              >
                {stat.value}
              </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#307fe2] rounded-2xl p-6 text-white shadow-lg shadow-blue-200">
            ...
            <p className="text-blue-100 text-sm mb-6 opacity-90">
              Akses fitur utama dengan sekali klik untuk mempercepat
              operasional.
            </p>
