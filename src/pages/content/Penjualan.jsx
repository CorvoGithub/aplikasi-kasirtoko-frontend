...
// Ensure this path matches where you saved StrukPrint.jsx
...
const Penjualan = () => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // --- HERE IS THE FIX: Calculate Logo URL explicitly ---
      ...
      const receiptData = {
          ...
          store_logo: logoUrl, // Pass this explicitly to StrukPrint
  ...
  return (
    <>
      {/* 1. HIDDEN RECEIPT COMPONENT (Outside layout for correct CSS positioning) */}
